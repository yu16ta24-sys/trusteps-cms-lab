    ...
    <main class="content">
        <section class="card">
            <div class="row">
                <div>
                    ...
                    <p class="page-subtitle">
                        v0.18.3.4は候補プレビューをカテゴリ別に整理。公式候補・ビルダー・SNS・EC等を枠で分け、枠単位で一括チェック/解除できる。
                    </p>
                </div>
                <div class="actions">
            ...
            <details class="help-panel" style="margin-top:20px;" open>
                <summary>v0.18.3.4でやること / やらないこと</summary>
                <div class="help-body">
            ...
            @if ($preview)
                ...
                <form method="POST" action="{{ route('discovery.lab.store') }}" style="margin-top:18px;">
                    ...
                    @foreach ($candidateGroups as $groupKey => $groupConfig)
                        ...
                        <details class="card" style="box-shadow:none; padding:16px; margin-top:14px;" {{ !empty($groupConfig['open']) ? 'open' : '' }}>
